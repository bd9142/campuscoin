...
allowing somebody to distribute a Bitcoin-Qt.app or campuscoin-qt-setup.exe with a valid
...
that the campuscoin-qt.exe file inside the installer had not been tampered with.
