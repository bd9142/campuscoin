...
{
    BOOST_CHECK(TestSplitHost("www.campuscoin.org", "www.campuscoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.campuscoin.org]", "www.campuscoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.campuscoin.org:80", "www.campuscoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.campuscoin.org]:80", "www.campuscoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4243", "127.0.0.1", 4243));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4243", "127.0.0.1", 4243));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4243", "::ffff:127.0.0.1", 4243));
    BOOST_CHECK(TestSplitHost("[::]:4243", "::", 4243));
    BOOST_CHECK(TestSplitHost("::4243", "::4243", -1));
    BOOST_CHECK(TestSplitHost(":4243", "", 4243));
    BOOST_CHECK(TestSplitHost("[]:4243", "", 4243));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4243", "127.0.0.1:4243"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4243", "[::]:4243"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
