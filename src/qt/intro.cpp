...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/campuscoin"));
     ...
     * override -datadir in the campuscoin.conf file in the default data directory
     * (to be consistent with campuscoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
