...
{
    return QCoreApplication::translate("campuscoin-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. campuscoin_de.qm (shortcut "de" needs to be defined in campuscoin.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. campuscoin_de_DE.qm (shortcut "de_DE" needs to be defined in campuscoin.qrc)
...
void BitcoinApplication::initializeResult(int retval)
{
    ...
    if(retval)
    {
        ...
        // campuscoin: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    /// 6. Determine availability of data directory and parse campuscoin.conf
    ...
    // campuscoin: links repeatedly have their payment requests routed to this process:
