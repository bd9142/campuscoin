...
unsigned int pnSeed[] =
{
    ...
    0xc15ebb6a, 0x2c08c452, 0xc7fd0652, 0x7604f8ce, 0xffb34242, 0xa4c2efd5, 0xe9614018, 0xab49e557,
...
public:
    CMainParams() {
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "This time is for CAMPUSCOIN";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        vSeeds.push_back(CDNSSeedData("campuscoin.sipa.be", "seed.campuscoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.campuscoin.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("campuscoinstats.com", "seed.campuscoinstats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("campuscoin.petertodd.org", "testnet-seed.campuscoin.petertodd.org"));
