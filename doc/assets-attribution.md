The following is a list of assets used in the campuscoin source and their proper attribution.
...
* License: MIT
* Site: [https://campuscointalk.org/index.php?topic=15276.0](https://campuscointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original campuscoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/campuscoin.icns, src/qt/res/src/campuscoin.svg,
	src/qt/res/src/campuscoin.ico, src/qt/res/src/campuscoin.png,
	src/qt/res/src/campuscoin_testnet.png, docs/campuscoin_logo_doxygen.png,
