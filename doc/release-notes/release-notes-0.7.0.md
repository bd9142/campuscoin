Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/campuscoin/files/Bitcoin/campuscoin-0.7.0/

We recommend that everybody running prior versions of campuscoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/campuscoin/campuscoin/tarball/v0.7.0  # .tar.gz
  https://github.com/campuscoin/campuscoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the campuscoin-qt package:
  sudo apt-get install campuscoin-qt
...
Core campuscoin handling and blockchain database
...
* Ensure a changed campuscoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for campuscoin-qt.exe
* (Windows only): add meta-data to campuscoin-qt.exe (e.g. description)
...
* Bash programmable completion for campuscoind(1)
