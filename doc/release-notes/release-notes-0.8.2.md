Bitcoin-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/campuscoin/files/Bitcoin/campuscoin-0.8.2/
...
The default fee for low-priority transactions is lowered from 0.0005 CCC 
(for each 1,000 bytes in the transaction; an average transaction is
about 500 bytes) to 0.0001 CCC.

Payments (transaction outputs) of 0.543 times the minimum relay fee
(0.00005430 CCC) are now considered 'non-standard', because storing them
...
MacOSX:
* OSX support for click-to-pay (campuscoin:) links
