Download URL: https://sourceforge.net/projects/campuscoin/files/Bitcoin/campuscoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CCC fee schedule (users still pay 0.01 CCC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #campuscoin00 - #campuscoin99
