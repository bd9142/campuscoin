...
- [Building Bitcoin](#building-campuscoin)
...
Clone the git repositories for campuscoin and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/campuscoin/campuscoin
```
...
In [doc/release-process.md](release-process.md) in the campuscoin repository under 'Fetch and build inputs'.
...
gitian builds' in [doc/release-process.md](release-process.md) in the campuscoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/campuscoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/campuscoin/campuscoin
...
For example:
```bash
URL=https://github.com/laanwj/campuscoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit campuscoin=${COMMIT} --url campuscoin=${URL} ../campuscoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit campuscoin=${COMMIT} --url campuscoin=${URL} ../campuscoin/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/campuscoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/campuscoin-build.assert
```
...
[campuscoin/gitian.sigs](https://github.com/campuscoin/gitian.sigs/) repository, or
