...
environ_default("CLONE_URL", "https://github.com/campuscoin/campuscoin.git")
...
environ_default("BUILD_PATH", "/mnt/campuscoin")
...
environ_default("GITHUB_REPO", "campuscoin/campuscoin")
